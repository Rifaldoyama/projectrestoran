    ...
    <nav class="bg-gray-800 fixed top-0 left-0 w-full z-50" x-data="{ isOpen: false }">
          ...
          <div class="flex items-center">
            ...
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                ...
                <x-navlink href="{{ route('customer.dashboard') }}" :active="request()->is('/')">Home</x-navlink>
                <x-navlink href="/menu" :active="request()->is('menu')">Menu</x-navlink>
                <x-navlink href="/about" :active="request()->is('about')">AboutUs</x-navlink>
                <x-navlink href="/contact" :active="request()->is('contact')">ContactUs</x-navlink>
              </div>
            </div>
          </div>
          <div class="hidden md:block">
              ...
              <div class="relative ml-3">
                <div>
                  ...
                  class="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                    ...
                    <img class="size-10 rounded-full" src="{{ asset('storage/' . Auth::user()->foto) }}" alt="">
                  </button>
                </div>
                <div  x-show="isOpen"
                ...
                class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black/5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
                  ...
                  <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-2">Logout</a>
      ...
      <div x-show="isOpen" class="md:hidden" id="mobile-menu">
        <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
          ...
          <a href="/menu" class="{{ request()->is('menu') ? 'bg-gray-900 text-white' :'text-gray-300 hover:bg-gray-700 hover:text-white'}} block rounded-md px-3 py-2 text-base font-medium">Menu</a>
